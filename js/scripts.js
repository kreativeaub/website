function initEndor() {
  ...
  $("<div class='filt-line'></div>")
    .duplicate(4)
    .appendTo(".filter-btn_container");
  ...
  $(
    ".gallery-filters-overlay , .pr-det_overlay , .sb-det_overlay , .pr-det_title "
  ).on({
    mouseenter: function () {
...
$(
  "<div class='page-load'><span class='mob-spinner'></span><div class='page-load_bg'></div></div>"
).appendTo("#main");
$("head").append(
